...
// Malcom
#define COCOAPODS_POD_AVAILABLE_Malcom
#define COCOAPODS_VERSION_MAJOR_Malcom 2
#define COCOAPODS_VERSION_MINOR_Malcom 0
#define COCOAPODS_VERSION_PATCH_Malcom 7
